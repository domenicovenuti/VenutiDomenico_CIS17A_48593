 ...
 * Created on October 1, 2021, 9:03 PM
 */
...
int *mode(const int *array,int arySize){
    int **maxf = nullptr;
    maxf = new int*[arySize];
    int a1 = 0;
    int b1 = 0;
    int c1 = 0;    
    
    for(a1 = 0; a1 < 2; a1++){
        maxf[a1] = new int[arySize];
    }
    
    for(a1 = 0; a1 < 2; a1++){
        for(b1 = 0; b1 < arySize; b1++){
            maxf[a1][b1] = -999;
        }
    }        
